...
defaultOptions.ui.errorMessages = {
    ...
    wordNotEmail: "No puedes usar tu email de contraseña",
    wordSimilarToUsername: "Tu contraseña no puede contener tu nombre",
    wordTwoCharacterClasses: "Usa diferentes caracteres",
    wordRepetitions: "Demasiadas repeticiones",
    wordSequences: "Tu contraseña contiene secuencia de números o caracteres"
};
...
(function ($, ui) {
    ...
    ui.initErrorList = function (options, $el) {
        ui.initHelper(options, $el, "<ul style='list-style:none' class='error-list'></ul>",
