...
function cargarPublicaciones(){
	...
	$.post( "usuarios.do", function( data ) {
		...
		for(i=0;i<json.length;i++){
            ...
            html += "<h5><span>La password del usuario: </spa><span>"+json[i].pwd+"</span> </h5>";
            html += "</div>";
            html += "<div class='panel-body'>";
            //html += "<p id='mensaje-"+i+"'>"+json[i].nombre+"</p>";
            html += "</div>";
            ...
            html += "<input type='hidden' id='delete-"+i+"' value='"+json[i].idUsuario+"'>";
            html += "</div>";
            html += "</div>";
            html += "</div>";
